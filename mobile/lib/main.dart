...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home: const MyHomePage(title: 'CashControl'),
    );
  }
}
...
class _MyHomePageState extends State<MyHomePage> {
  String apiStatus = 'Sin comprobar';
...
Future<void> checkApiConnection() async {
  try {
    ...
    if (response.statusCode == 200) {
      ...
      setState(() {
        apiStatus = 'Error HTTP: ${response.statusCode}';
      });
    }
  } catch (error) {
    setState(() {
      apiStatus = 'No fue posible conectar con la API';
    });
  }
}
  int _counter = 0;
